...
import { Actions, Arrow, Card, Copy, Data, NotifyOkIcon, User } from '../../components/Icons';
        ...
        <section className="profile">
            <div className="container">
                <div className="profile__inner">
                    ...
                    <div className="profile__content admin__content">
                                ...
                                <div className="item-admin__content">
                                    ...
                                    <div className="section-admin active">
                                        ...
                                        <div className="section-admin__content">
                                            ...
                                            <Button className="section-admin__btn">Верифицировать</Button>
